...
build_images && push_images && list_images

# Puedes declarar una estructura donde se guarden los pasos ejecutados con exito y compararlo con una referencia para ver si es necesario volver a ejecutarlo
